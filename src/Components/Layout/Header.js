        ...
        <div className="sticky-top">
            <Navbar bg="light" collapseOnSelect expand="lg" >
                <Container>
                    ...
                    <Navbar.Toggle aria-controls="responsive-navbar-nav" style={{ fontSize: "25px", color: "black", background: " " }} className="ms-auto" > <FontAwesomeIcon icon={faBars} /> </Navbar.Toggle>
